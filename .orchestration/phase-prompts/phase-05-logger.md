...
## Obiettivo
Audit trail completo: ogni decisione (approvata o rifiutata) persistita su SQLite + file rotante.
...
- `log_order_result(order_result: OrderResult, proposal: TradeProposal)`:
  ...
  - opzionale: UPDATE riga corrispondente con `order_id` se vuoi tracciare; per semplicità log solo testuale
